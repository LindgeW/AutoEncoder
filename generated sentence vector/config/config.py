...
def arg_parse():
    ...
    parser.add_argument('-ep', '--epochs', type=int, default=15, help='the number of iter')

    # 配置模型参数
    parser.add_argument('-hz', '--hidden_size', type=int, default=100, help='the size of hidden layer')
    parser.add_argument('--num_layers', type=int, default=1, help='the number of hidden layer')
